<?php 
	if(isset($_POST['Email'])) { 
		...
		if(!isset($_POST['Name']) || !isset($_POST['Company']) || !isset($_POST['Email']) || !isset($_POST['Subject']) || !isset($_POST['Message'])) { 
			died('Lo sentimos pero parece haber un problema con los datos enviados.'); 
		} 
		
		// Crear las variables que recolectaran la información de cada campo 
		$name = $_POST['Name']; // requerido 
		$company = $_POST['Company']; // no requerido 
